...
<head>
  ...
  <title>paymeant</title>
  <link rel="stylesheet" href="css/card.css">
  <script src="card.css" defer></script>
</head>
  ...
  <div class="modal">
    <div class="modal__container">
      <div class="modal__featured">
            <svg class="nc-icon glyph" xmlns="progress.html" xmlns:xlink="progress.html" x="0px" y="0px" width="32px"
        ...
        <img src="images/card-removebg-preview.png" width="300px" height="320px" style="padding:80px;"
      ...
      <div class="modal__content">
        ...
        <form>
          <ul class="form-list">
            ...
            <li>
              <button type="submit" class="button" name="sub"><a href="good bay.html">Pay Now</a></button>
            </li>
          </ul>
        </form>
