...
<head>
    ...
    <link rel="stylesheet" href="css/filesRenewal of passport.css">
    <link rel="stylesheet" href="js/filesRenewal of passport.js">
    <title> filesRenewal of passport</title>
</head>
<body>
    <section class="container">
        <header><b>Data registration</b></header>
        <button type="button" class="button--transparent button--close"><a href="Renewal of passport.html">
          ...
          <form action="uploadre.php" method="post" class="form" enctype = "multipart/form-data";>
            ...
            <div class="input-box1">
                <label>Your passport image</label>
                <input type="file" placeholder="Enter Your passport" required name="user_pass">
            </div>
